...
public class AeroKoiEntity extends NeutralWaterMob implements IAnimatable {

    private final AnimationFactory factory = new AnimationFactory(this);

    public AeroKoiEntity(EntityType<? extends WaterCreatureEntity> entityType, World world) {
    ...
    protected void initGoals() {
        super.initGoals();
        this.goalSelector.add(2, new AeroKoiEntity.RangedAttackGoal(this));
    ...
    private static class RangedAttackGoal extends Goal {
        ...
        public RangedAttackGoal(AeroKoiEntity koi) {
            this.koi = koi;
