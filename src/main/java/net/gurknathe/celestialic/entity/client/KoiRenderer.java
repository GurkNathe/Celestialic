    ...
    public static final Map<KoiVariant, Identifier> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(KoiVariant.class), (map) -> {
                map.put(KoiVariant.DEFAULT,
                        new Identifier(Celestialic.MOD_ID, "textures/entity/koi/koi_base.png"));
                map.put(KoiVariant.TANCHO,
                        new Identifier(Celestialic.MOD_ID, "textures/entity/koi/koi_tancho.png"));
                map.put(KoiVariant.KOHAKU,
                        new Identifier(Celestialic.MOD_ID, "textures/entity/koi/koi_kohaku.png"));
                map.put(KoiVariant.SANKE,
                        new Identifier(Celestialic.MOD_ID, "textures/entity/koi/koi_sanke.png"));
                map.put(KoiVariant.SHOWA,
                        new Identifier(Celestialic.MOD_ID, "textures/entity/koi/koi_showa.png"));
                map.put(KoiVariant.UTSURIMONO_RED,
                        new Identifier(Celestialic.MOD_ID, "textures/entity/koi/koi_utsurimono_red.png"));
                map.put(KoiVariant.UTSURIMONO_WHITE,
                        new Identifier(Celestialic.MOD_ID, "textures/entity/koi/koi_utsurimono_white.png"));
                map.put(KoiVariant.CHAGOI,
                        new Identifier(Celestialic.MOD_ID, "textures/entity/koi/koi_chagoi.png"));
            });
